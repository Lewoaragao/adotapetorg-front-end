...
function TituloPagina({ titulo }) {
    ...
    useEffect(() => {
        ...
        let relCanonical = !!document.querySelector("link[rel='canonical']") ? document.querySelector("link[rel='canonical']") : document.createElement("link");
        relCanonical.setAttribute("rel", "canonical");
        relCanonical.setAttribute("href", process.env.REACT_APP_PUBLIC_URL + locationPathname);
